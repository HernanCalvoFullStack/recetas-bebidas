  ...
  return (
    <header className={ isHome ? "bg-header bg-center bg-cover" : "bg-slate-800"}>
        <div className="mx-auto container px-5 py-16">
            ...
            {isHome && (
              <form className="md:w-1/2 2xl:1/3 bg-orange-400 my-32 p-10 rounded-lg shadow space-y-6" onSubmit={handleSubmit}>
                <div className="space-y-4">
                  ...
                  <input 
                    ...
                    placeholder="Nombre o Ingrediente. Ej. Vodka, Tequila, Vino"
